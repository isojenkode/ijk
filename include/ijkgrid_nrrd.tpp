...
namespace IJK {
  ...
  // **************************************************
  /// @name WRAP SCALAR DATA IN NRRD DATA STRUCTURE.
  // **************************************************
  ...
  /// @brief Write scalar grid in nrrd file. Set IoStateEncoding.
  template <typename GTYPE>
  void write_scalar_grid_nrrd_encoding
  (const char * output_filename, const GTYPE & grid,
   const NrrdEncoding * nrrd_encoding)
  {
    IJK::PROCEDURE_ERROR error("write_scalar_grid_nrrd_encoding");
    ...
    nrrdIoStateEncodingSet(nio, nrrd_encoding);
  ...
  /// Set IoStateEncoding and add header information.
  template <typename GTYPE, typename DTYPE, typename ATYPE>
  void write_scalar_grid_nrrd_encoding
  (const char * output_filename, const GTYPE & grid,
   const NrrdEncoding * nrrd_encoding,
  ...
  /// Write scalar grid in nrrd file, ASCII format.
  template <typename GTYPE>
  void write_scalar_grid_nrrd_ascii
  (const char * output_filename, const GTYPE & grid)
  {
    write_scalar_grid_nrrd_encoding
      (output_filename, grid, nrrdEncodingAscii); 
  }


  /// @overload
  /// \brief Write scalar grid in nrrd file, ASCII format. (C++ string)
  /// - C++ string version.
  template <typename GTYPE>
  void write_scalar_grid_nrrd_ascii
  (const std::string & output_filename, const GTYPE & grid)
  {
    write_scalar_grid_nrrd_ascii(output_filename.c_str(), grid);
  }


  /// @overload
  /// \brief Write scalar grid in nrrd file, ASCII format. Add header information.
  template <typename GTYPE, typename DTYPE, typename ATYPE>
  void write_scalar_grid_nrrd_ascii
  (const char * output_filename, const GTYPE & grid, 
   const NRRD_DATA<DTYPE,ATYPE> & nrrd_header)
  {
    write_scalar_grid_nrrd_encoding
      (output_filename, grid, nrrdEncodingAscii, nrrd_header);
  }


  /// @overload
  /// @brief Write scalar grid in nrrd file, Ascii format. (Header and C++ string.)
  ...
  (const std::string & output_filename, const GTYPE & grid, 
   const NRRD_DATA<DTYPE,ATYPE> & nrrd_header)
  {
    write_scalar_grid_nrrd_ascii(output_filename.c_str(), grid, nrrd_header);
  }
  ...
  {
    write_scalar_grid_nrrd_encoding
      (output_filename, grid, nrrdEncodingGzip); 
  }
  ...
  {
    write_scalar_grid_nrrd_encoding
      (output_filename, grid, nrrdEncodingGzip, nrrd_header);
  }
