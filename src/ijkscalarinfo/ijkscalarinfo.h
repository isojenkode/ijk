...
namespace IJKSCALARINFO {
  ...
  /// @brief Bitset size storing cube vertex locations.
  /// @pre CUBE_VERTEX_BITSET_SIZE <= scalar_grid.Dimension().
  /// - Almost always 8.
  const int CUBE_VERTEX_BITSET_SIZE(8);
  ...
  <CUBE_VERTEX_BITSET_SIZE,NUM_TYPE, AXIS_SIZE_TYPE, VERTEX_INDEX, NUM_TYPE> 
  INFO_GRID;
