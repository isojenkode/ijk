...
namespace IJKMESHINFO {
  ...
  public:
    ...
    /// Minimum number of vertices in any polytope in the polymesh.
    int min_num_poly_vert;

    /// Maximum number of vertices in any polytope in the polymesh.
    int max_num_poly_vert;
  ...
  public:
    ...
    /// @brief Return true if mesh dimension is set.
    bool IsMeshDimensionSet() const
    { return is_mesh_dimension_set; }
    
    /// @brief Return number of polytopes.
    int NumPoly() const
    ...
    void SetMeshDimension(const int d);
  };
