...
namespace IJKMESHINFO {
  ...
  /// @brief Output vertices of polytope ipoly.
  void output_poly_vertices
  (const int dimension, const POLYMESH_TYPE & polymesh, 
   const COORD_TYPE * vertex_coord, const int poly_index);

  /// @brief Output information about polytope ipoly.
  void output_polytope_info
  (const int dimension, const POLYMESH_TYPE & polymesh, 
   const COORD_TYPE * vertex_coord, const int poly_index);

  /// @overload
  /// @brief Output information about list of polytopes.
  void output_polytope_info
  (const int dimension, const POLYMESH_TYPE & polymesh, 
  ...
  /*!
   *  @brief Output information about 2D polygon ipoly.
   *  - Output vertices, angles and edge lengths.
   */
  void output_polygon_info
  (const int dimension, const POLYMESH_TYPE & polymesh, 
   const COORD_TYPE * vertex_coord, const int poly_index,
  ...
  /*!
   *  @overload
   *  @brief Output information about list of 2D polygons.
   */
  void output_polygon_info
  (const int dimension, const POLYMESH_TYPE & polymesh, 
   const COORD_TYPE * vertex_coord,
