...
void usage_msg()
{
  cout << "Usage: ijkMCtable_invert [-h] [-replace] {input isotable file} [{output isotable file}]"
       << endl;
}
...
void help_msg()
{
  ...
  cout << "ijkMCtable_invert - Invert isosurface lookup table."
       << endl;
  cout << "    Swap table entry it0 and it1 where it1 is index it0"
       << endl;
  cout << "    with all '+' mapped to '-' and all '-' mapped to '+'."
       << endl;
  cout << endl;

  cout << "OPTIONS:" << endl;
  cout << "-replace:   Replace input file with new isotable." << endl;
  cout << "-help | -h: Print this help message (and exit)." << endl;
