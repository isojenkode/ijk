...
namespace IJKGENCOORD {
   ...
   VTYPE2 xdir[], VTYPE2 ydir[], VTYPE2 zdir[])
  {
    ...
    // *** max_small_magnitude should be in input parameter list.
    const VTYPE0 max_small_magnitude = 0.0;
    IJK::normalize_vector(DIM3, v0, max_small_magnitude, xdir);
    IJK::compute_orthogonal_vector(DIM3, v1, xdir, ydir);
    IJK::normalize_vector(DIM3, ydir, max_small_magnitude, ydir);
