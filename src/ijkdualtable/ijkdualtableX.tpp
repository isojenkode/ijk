/*!
 *  \file ijkdualtableX.tpp
 *  @brief Extended dual lookup tables of isosurface and interval volume vertices.
 *  - Version 0.6.0
 */
...
#ifndef _IJKDUALTABLE_X_TPP_
#define _IJKDUALTABLE_X_TPP_
