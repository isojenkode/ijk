...
/*
  ...
  Copyright (C) 2016-2025 Rephael Wenger
...
namespace IJKDUAL {
   ...
   DUALISO_INFO & dualiso_info)
  {
    ...
    const bool flag_special_planar_quad_orth_to_dual_edge =
      param.envelope_flag_special_planar_quad_orth_to_dual_edge;
    ...
    compute_quad_diagonals_deep_in_envelope
      (grid, isopoly_vert, isov_list, vertex_coord,
       envelope_offset, flag_special_planar_quad_orth_to_dual_edge,
   ...
   ISOSURFACE_TYPE & dual_isosurface)
  {
    ...
    const bool flag_move_all_isov_away_from_cube_boundaries =
      dualiso_data.iso_vertex_position_param.flag_move_all_isov_away_from_cube_boundaries;
    ...
    if (dual_isosurface.vertex_coord.size() > 0) {
      ...
      if (flag_move_all_isov_away_from_cube_boundaries ||
        ...
        IJK::compute_all_isov_coord_on_grid_edge_linear_offset
