/*!
 *  @file ijkMCtable_ambig.h
 *  @brief Class containing ambiguity information about Marching Cubes isosurface lookup tables.
 *  - Version 0.6.0
 */
...
namespace IJKMCUBE_TABLE {
  ...
  // constructors
    ...
    /// Set ambiguity table.
    void SetAmbiguityTable(const ISOTABLE_POLY_BASE & poly);
