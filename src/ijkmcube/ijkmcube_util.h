 ...
 *  @brief ijkmcube utility functions.
 *  - Version 0.6.0
 */
...
// **************************************************
  ...
  /// @brief Return file name prefix of isosurface lookup table  
  ///    for given type, dimension and polytope.
  std::string get_isotable_filename_prefix
    (const int dimension, const char * poly_name, const ISOTABLE_TYPE type);

  /// @brief Return file name suffix of isosurface lookup table  
  ///    for given type, dimension and polytope.
  std::string get_isotable_filename_suffix
    (const int dimension, const char * poly_name, const ISOTABLE_TYPE type);
...
// **************************************************
  ...
  bool check_isotable_encoding
    (const ISOSURFACE_TABLE & isotable, 
     const IJKMCUBE_TABLE::ENCODING encoding, IJK::ERROR & error);
