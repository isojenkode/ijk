 ...
 *  @brief Type definitions for ijkmcube.
 *  - Version 0.6.0
 */
...
// **************************************************
// IJKMCUBE_TABLE TYPES
// **************************************************

  using IJKMCUBE_TABLE::ISOSURFACE_TABLE;
  using IJKMCUBE_TABLE::ISOSURFACE_TABLE_AMBIG_INFO;
  using IJKMCUBE_TABLE::ISOTABLE_POLY_BASE;
  using IJKMCUBE_TABLE::TABLE_INDEX;
...
// **************************************************
  ...
  /*!
   *  @brief Type of mesh edge representation.
   *  - EDGE_ID: Represent edge by single integer identifier.
   *  - EDGE_ENDPOINT_PAIR: Represent edge by a pair of integer
   *    indentifiers of the endpoints.
   */
  ...
  /*!
   *  @brief Isosurface topology type.
